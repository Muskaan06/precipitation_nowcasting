...
class SimVP_Model(nn.Module):
    ...
    def __init__(self, in_shape, T_in, T_out,  **kwargs):
        ...
        N_S, N_T = configs.N_S, configs.N_T
        spatio_kernel_enc, spatio_kernel_dec = configs.spatio_kernel_enc, configs.spatio_kernel_dec
    ...
    def predict(self, frames_in, frames_gt=None, compute_loss=False, **kwargs):
        ...
        if compute_loss:
            loss = self.MSE_criterion(frames_pred, frames_gt)
        else:
            loss = None
